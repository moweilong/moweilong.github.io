...
const teekConfig = defineTeekConfig({
  ...
  blogger: {
    ...
    circleBgImg: "https://wiki.moweilong.com/images/TeekBg/14.webp", // 侧边栏个人头像圆形背景图
      ...
      AutoFrontmatter({
          ...
          transform: (frontMatter: Record<string, any>, fileInfo: FileInfo) => {
              ...
              const rules: TransformRule[] = [
                  ...
                  { folderName: "31.网络", prefix: "/network/$uuid5", removeLevel: 99}, // 清空前缀并且添加前缀使用随机数
                  ...
                  { folderName: "9000.Kubernetes", prefix: "/kubernetes/$uuid5", removeLevel: 99}, // 清空前缀并且添加前缀使用随机数
                  { folderName: "9999.统一应用日志中心", prefix: "/zhuanti/ualc/$uuid5", removeLevel: 99}, // 清空前缀并且添加前缀使用随机数
